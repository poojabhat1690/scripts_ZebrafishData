...
refSeq_unmerged = read.table("/Volumes/groups-1//ameres/Pooja/Projects/zebrafishAnnotation/dr10/refSeq_dr10_GRCh38_20170504//processed/refSeq_mrna_utrsPresent.bed",stringsAsFactors = F)
refFlat <- read.table("/Volumes/groups-1//ameres/Pooja/Projects/zebrafishAnnotation/dr10/refSeq_dr10_GRCh38_20170504//refFlat.txt", stringsAsFactors = F)
...
ensembl = read.delim("/Volumes/groups-1//ameres/Pooja/Projects/zebrafishAnnotation/dr10//ensembl_dr10_Ensembl_Genes_88//proteinCoding_annotatedUTRs.bed",stringsAsFactors = F,header = F)
ensemblTrans <- read.delim("//Volumes/groups-1//ameres/Pooja/Projects/zebrafishAnnotation/dr10//ensembl_dr10_Ensembl_Genes_88/transcriptStartsAndEnds_all.txt", stringsAsFactors = F, header = T)
head(ensemblTrans)
...
ends_all= read.delim("/Volumes/groups-1/ameres/Pooja/Projects/zebrafishAnnotation/output/final90percent/ends_greater90percent_intergenic_n100.bed",stringsAsFactors = F,header=F)
...
library(ggplot2)
pdf("/Volumes/groups-1///ameres/Pooja/Projects/zebrafishAnnotation/zebrafish_analysis/plots/distanceOfEndsFromAnnotations.pdf")
...
p = p+ xlab("Minimum distance of end from annotated refSeq and Ensembl 3' ends") + ylab("Genes") + ggtitle(paste0("allEnds n=",nrow(allEnds_total_numberEnds_beforeFilter)))
print(p)
...
refSeqTpm = read.delim("/Volumes/groups-1/ameres/Pooja/Projects/zebrafishAnnotation/zebrafish_analysis/importantDataframes/countingWindowsGreaterThan5cpm.bed",header = T,stringsAsFactors = F)
...
pdf("/Volumes/groups-1/ameres/Pooja/Projects/zebrafishAnnotation/zebrafish_analysis/plots//distanceAfterFIlter_tmpgreaterThan10.pdf")
