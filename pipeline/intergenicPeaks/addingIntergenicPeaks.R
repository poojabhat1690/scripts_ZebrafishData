...
colnames(overlapPeaks) = c("chr",	"start","end"	,"peakName"	,"numberOfpolyAends"	,"strand",	"120ntSeq"	,"internalId(chr_start)",	"20nts (+1 to +20)",	"Acontent"	,"upStreamSequence(-40 to -5)",	"Acontent_motif",	"chr",	"RNAseqbinStart",	"RNAseqbinEnd",	"geneName","score",	"strand","refSeq/ensemblid","closestDistancetonextexon", paste0("RNAseqReads_rep", 1:numReplicates),	"mean(RNAseq)",	"RNAseq(bin)/rnaSeq(inUTR)")										
