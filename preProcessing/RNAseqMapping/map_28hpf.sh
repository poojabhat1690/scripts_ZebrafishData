...
samtools index /clustertmp/pooja/STARmapping//28hpf/28hpf_1Aligned.sortedByCoord.out.bam /clustertmp/pooja/STARmapping//28hpf/28hpf_1Aligned.sortedByCoord.out.bam.bai
samtools index /clustertmp/pooja/STARmapping//28hpf/28hpf_2Aligned.sortedByCoord.out.bam /clustertmp/pooja/STARmapping//28hpf/28hpf_2Aligned.sortedByCoord.out.bam.bai
