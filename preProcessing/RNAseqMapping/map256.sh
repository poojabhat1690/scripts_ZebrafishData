...
samtools index /clustertmp/pooja/STARmapping/265cellStage/256Cell_1Aligned.sortedByCoord.out.bam /clustertmp/pooja/STARmapping/265cellStage/256Cell_1Aligned.sortedByCoord.out.bam.bai
