...
samtools index /clustertmp/pooja/STARmapping/Sperm1//zf_sperm1_longRNA_2Aligned.sortedByCoord.out.bam /clustertmp/pooja/STARmapping/Sperm1//zf_sperm1_longRNA_2Aligned.sortedByCoord.out.bam.bai
